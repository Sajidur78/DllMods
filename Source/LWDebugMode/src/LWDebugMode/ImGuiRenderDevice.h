...
namespace app::imgui
{
	...
	public:
		...
		void SetScreenBounds(const csl::ut::Rectangle2<int>& bound) override;
		...
		void DrawString(void* a1, const gindows::device::Font* font, const csl::ut::Rectangle2<int>& rect, const csl::ut::Point2<int>& p1, const csl::ut::Point2<int>& p2, const csl::ut::Color8& color, const char* text) override;
